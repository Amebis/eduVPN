...
WIX_CANDLE_FLAGS_CFG_PLAT_CLIENT=$(WIX_CANDLE_FLAGS_CFG_PLAT) \
	-dTAPWin.ProductGUID="$(TAPWIN_PRODUCT_GUID_TEMPLATE:__=01)" \
	-dOpenVPN.ProductGUID="$(OPENVPN_PRODUCT_GUID_TEMPLATE:__=01)" \
	-dCore.ProductGUID="$(PRODUCT_GUID_TEMPLATE:__=01)" \
!IF "$(PLAT)" == "x64"
