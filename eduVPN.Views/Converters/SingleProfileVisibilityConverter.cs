...
{
    /// <summary>
    /// Returns <see cref="Visibility.Visible"/> if profile list contains exactly one profile; or <see cref="Visibility.Collapsed"/> otherwise.
    /// </summary>
    public class SingleProfileVisibilityConverter : IValueConverter
    {
        #region Methods
