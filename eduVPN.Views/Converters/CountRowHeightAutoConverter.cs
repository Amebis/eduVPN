...
{
    /// <summary>
    /// Returns <c>Auto</c> if the value is non-zero; or <c>0px</c> otherwise.
    /// </summary>
    public class CountRowHeightAutoConverter : IValueConverter
    {
        #region Fields
        ...
        {
            return value is int i && i > 0 ? GridLength.Auto : ZeroGridLength;
        }
