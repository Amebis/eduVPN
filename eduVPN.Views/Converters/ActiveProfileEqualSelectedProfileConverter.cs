...
{
    /// <summary>
    /// Returns <see cref="true"/> if <c>value[0]</c> and <c>value[1]</c> represent the same profile; or <see cref="false"/> otherwise.
    /// </summary>
    public class ActiveProfileEqualSelectedProfileConverter : IMultiValueConverter
    {
        #region Methods
