            ...
            if (value is SessionStatusType status_type)
            {
                try
                {
                    return new BitmapImage(
                        new Uri(
                            String.Format(
                                "pack://application:,,,/Resources/SessionStatusTypeIcon{0}.ico",
                                Enum.GetName(typeof(SessionStatusType), status_type))));
                }
                catch { }
            }

            return new BitmapImage(new Uri("pack://application:,,,/Resources/SessionStatusTypeIconInitializing.ico"));
        }
