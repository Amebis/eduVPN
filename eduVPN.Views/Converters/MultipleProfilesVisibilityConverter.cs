...
{
    /// <summary>
    /// Returns <see cref="Visibility.Visible"/> if profile list contains more than one profiles; or <see cref="Visibility.Collapsed"/> otherwise.
    /// </summary>
    public class MultipleProfilesVisibilityConverter : IValueConverter
    {
        #region Methods
